...
/** requestPasswordReset POST /api/user/forgot/request */
export async function requestPasswordResetUsingPOST(
  body: { userAccount: string },
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/forgot/request', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** resetPasswordNoCode POST /api/user/forgot/reset/no-code */
export async function resetPasswordNoCodeUsingPOST(
  body: { userAccount: string; newPassword: string; checkPassword: string },
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/forgot/reset/no-code', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
